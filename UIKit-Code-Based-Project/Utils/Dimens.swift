...
//
//  Created by switchMac on 10/13/24.
//
...
class Dimens {
    ...
    static let prevForwardButtonSize = 30.0
    static let containerPadding = 10.0
    static let containerHeight = 70.0
    
    
    static let detailViewPadding = 24.0
    
    static let chipViewVerticalInsets = 2.0
